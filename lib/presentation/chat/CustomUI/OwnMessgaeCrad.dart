              ...
              child: InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("${message.content}",style: TextStyle(color:message.isLink== 0 ?  Colors.black :  MyColor.primaryColor,fontWeight:message.isLink== 0 ?FontWeight.normal : FontWeight.bold),
                    ),
                  ],
                ),
              ),
