        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              ...
              setState(() {});
              bool isLiked = await  ApiRepository.postLike(userId:"${widget.post.id}" );
            },
            child: CustomImageView(
              imagePath: widget.colors == true ?   "assets/image/blue_unliked.svg" : 'assets/image/blue_unliked.svg',
              width: 24.aw,
              height: 24.aw,
            ),
          ):
          InkWell(
              ...
              child: CustomImageView(
                imagePath: widget.colors == true ?  "assets/image/liked_blue_filled.svg" : 'assets/image/liked_blue_filled.svg',
                width: 24.aw,
                height: 24.aw,
              )
          ),
                        ...
                        Obx(
                          () => dashBoardController.isLoadingONComments.value
                              ...
                              : Expanded(
                                  child: Obx(
                                    () => dashBoardController
                                            .getCommentsModel.comments!.isEmpty
                                        ? const Center(
                                            child: Text(
                                              "No comments yet",
                                              style: TextStyle(
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            if("${dashBoardController.getCommentsModel.comments?[index].user?.id}"== "${PrefUtils().getUserId()}")
                                                              InkWell(
                                                                onTap: () async {
                                                                  await ApiRepository.deletePostComment(postId: "${widget.post.id}", commentId: "${dashBoardController.getCommentsModel.comments?[index].id}");
                          ...
                          child: Obx(
                            () => dashBoardController.isLoadingONShare.value
                              ...
                              itemBuilder: (BuildContext context,
                                ...
                                //             createChatModel = await ApiRepository.createChat(userId: "${dashBoardController.getAllFriendsModel.friends?[index].id}");
                                //             ApiRepository.sendMessage(
                                //                 typeBlog2VLog3Photo1: "3",
                                //                 message: ' Sent a Vlog by ${widget.post.user?.handle}',
                                //                 chatId: '${createChatModel.payload?.id}',
                                ...
                                //             //         chatId:
                                //             //             '${chatScreenController.chatsModel.chats![index].id}',
