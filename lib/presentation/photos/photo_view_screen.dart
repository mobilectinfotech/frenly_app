...
class _PostFullViewScreenState extends State<PostFullViewScreen> {
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          Get.back();
                          Get.back();
                          await ApiRepository.deletePost(
                              postId:
                                  "${controller.postSingleViewModel?.post?.id}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(),
        body: Obx(
          () => controller.isLoadingPostsingle.value
              ? Center(
              ...
              : Column(
                  ...
                  children: [
                        ...
                        onTap: () {
                          if (widget.own == true) {
                            ...
                            Get.to(() => UserProfileScreen(
                                userId:
                                    "${controller.postSingleViewModel?.post?.user?.id}"));
                          }
                        },
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          ...
                          children: [
                            CustomImageView(
                              ...
                              imagePath: controller
                                  .postSingleViewModel?.post?.user?.avatarUrl,
                            ...
                            Column(
                                ...
                                children: [
                                  Text(
                                    "${controller.postSingleViewModel?.post?.user?.fullName}"
                                        .capitalizeFirst!,
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontWeight: FontWeight.w700,
                                  ...
                                  Text(
                                    "${controller.postSingleViewModel?.post?.user?.handle}",
                                    style: TextStyle(
                                      color: Colors.grey,
                    ...
                    Stack(
                      children: [
                        CustomImageView(
                          ...
                          imagePath:
                              controller.postSingleViewModel?.post?.imageUrl,
                          fit: BoxFit.cover,
                        ),
                        InkWell(
                          onTap: () {
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: HashtagText(
                                          caption:
                                              "${controller.postSingleViewModel?.post?.caption}"),
                                    ),
                                  ),
                    ...
                    PostLikeCommentsShareView(
                      post: controller.postSingleViewModel?.post,
                    ),
                  ],
                ),
        ));
