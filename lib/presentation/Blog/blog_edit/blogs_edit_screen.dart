...
class BlogsEditScreen extends StatefulWidget {
  ...
  @override
  State<BlogsEditScreen> createState() => _BlogsEditScreenState();
}

class _BlogsEditScreenState extends State<BlogsEditScreen> {


  BlogEditController controller = Get.put(BlogEditController());
                ...
                child: Stack(
                  children: [
                    CustomImageView(
                      ...
                      imagePath: controller.coverPhoto?.path ?? widget.getBlogByIdModel.blog?.imageUrl,
                      fit: BoxFit.contain,
                    ),
                    Positioned(
                        right: 15.aw,
                          ...
                          onTap: () {
                            if (_formKeyLogin.currentState!.validate()) {
                              if(controller.tags.isNotEmpty){
                                controller.updateBlog(id: widget.getBlogByIdModel.blog!.id.toString());
                              }else{
