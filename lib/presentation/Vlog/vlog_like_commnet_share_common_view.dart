                              ...
                              : Expanded(
                                  child: Obx(
                                    () => trendingVlogController
                                        ...
                                        : ListView.builder(
                                            reverse: true,
                                            itemCount: trendingVlogController
                                                .getCommentsModel
                                                .comments
                                                ?.length,
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Row(
                                                                children: [
                                                                  Text("${trendingVlogController.getCommentsModel.comments?[index].user?.fullName}  ",
                                                                                style:
                                                                                    TextStyle(
                                                                                  color: Colors
                                                                                      .black,
                                                              ...
                                                              Row(
                                                                children: [
                                                                  ...
                                                                  if("${trendingVlogController.getCommentsModel.comments?[index].user?.id}"== "${PrefUtils().getUserId()}")
                                                                  InkWell(
                                                                    onTap: () async {
                                                                     await ApiRepository.deleteVlogComment(vlogId: "${widget.vlog.id}", commentId: "${trendingVlogController.getCommentsModel.comments?[index].id}");
                                                                      trendingVlogController.getComments(vlogId: vlogId);
